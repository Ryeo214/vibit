...
"""Verify that starting vibit with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vibit with -h for help text")
        ...
        self.log.info("Start vibit with -version for version information")
        ...
        self.log.info("Start vibitd with -fakearg to make sure it does not start")
