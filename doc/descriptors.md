# Support for Output Descriptors in Vibit Core

Since Vibit Core v0.17, there is support for Output Descriptors. This is a
...
existing Vibit Core wallets, a convenience function `combo` is
