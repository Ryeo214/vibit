Vibit Core version *0.15.1* is now available from:

  <https://download.vibit.org/vibit-0.15.1/>
...
A number of changes to the way Vibit Core deals with peer connections and invalid blocks
