Contributing to Vibit Core
============================

The Vibit Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Vibit Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/vibit-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to vibit-qt
...
The following applies to code changes to the Vibit Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Vibit
Network Protocol consensus changes.

Whether a pull request is merged into Vibit Core rests with the project merge
...
Patches that change Vibit consensus rules are considerably more involved than
...
Where a patch set proposes to change the Vibit consensus, it must have been
...
The project leader is the release manager for each Vibit Core release.
