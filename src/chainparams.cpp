...
{
    const char* pszTimestamp = "Hanoi Times 19/Dec/2024 A first block is created";
    const CScript genesisOutputScript = CScript() << ParseHex("04af5597db7ce9a05877bbbf7fdeb215c070c2d46e65418596eb5f5b3f3f8758271e3ddfdf92186ee52d70b00014620a9b8f9c517ecb6849d23ae2ecbc71d2bceb") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0xf69ab2105f559a785b094e27516cd2a85fe0fb27ad51d030727483b1d14f9dac"); // 2772730
        ...
        genesis = CreateGenesisBlock(1734582363, 1255564, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf69ab2105f559a785b094e27516cd2a85fe0fb27ad51d030727483b1d14f9dac"));
        assert(genesis.hashMerkleRoot == uint256S("0xa736b7507caebf78ade001126bb5d684c7e578a759f9b1cdd143fae6a4feb071"));
        ...
        vSeeds.emplace_back("seed-a.vibit.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.vibittools.com");
        vSeeds.emplace_back("dnsseed.vibitpool.org");
        vSeeds.emplace_back("dnsseed.koin-project.com");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,86); // Ký tự 'v'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,20);  // Ký tự 'C'
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,60); // Ký tự 'R'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,250); // Ký tự 'z'
        base58Prefixes[EXT_PUBLIC_KEY] = {0x05, 0x99, 0xAA, 0x1F};          // Ký tự bắt đầu là 'vpup'
        base58Prefixes[EXT_SECRET_KEY] = {0x05, 0x99, 0xAD, 0xE5};          // Ký tự bắt đầu là 'vprv'
        ...
        checkpointData = {
            {
                {  0, uint256S("0xf69ab2105f559a785b094e27516cd2a85fe0fb27ad51d030727483b1d14f9dac")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.vibittools.com");
        vSeeds.emplace_back("seed-b.vibit.loshan.co.uk");
