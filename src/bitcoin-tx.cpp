...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " vibit-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  vibit-tx [options] <hex-tx> [commands]  Update hex-encoded vibit transaction\n" +
            "or:     vibit-tx [options] -create [commands]   Create hex-encoded vibit transaction\n" +
            "\n";
