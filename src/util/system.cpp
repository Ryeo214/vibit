...
const char * const BITCOIN_CONF_FILENAME = "vibit.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Vibit";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Vibit";
#else
    // Unix-like
    return pathRet / ".vibit";
#endif
#endif
}
